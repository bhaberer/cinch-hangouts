...
describe Cinch::Plugins::Hangouts do
  ...
  describe 'subscriptions' do
    it 'should allow users to subscribe' do
      ...
      get_replies(msg).first.should include("You are now subscribed")
    end
